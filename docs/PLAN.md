...
| Tests      | After each stage, on logic that branches. 81 measured today (planned ~25)                                 | The brief never mentions testing; a proportionate suite is a professional-standards signal, not a discipline framework                                |
...
design/                   Tally design source — reference, not specification; committed, never imported
